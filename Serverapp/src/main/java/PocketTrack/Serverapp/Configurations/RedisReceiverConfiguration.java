...
public class RedisReceiverConfiguration {
    ...
    // Jackson2JsonRedisSerializer<>(objectMapper, RegisterData.class));
    // return messageListenerAdapter;
    // }

    // @Bean("generateParticipantAccountMessageListener")
    // MessageListenerAdapter generateParticipantAccountMessageListener(AuthReceiver
    // receiver) {
    // MessageListenerAdapter messageListenerAdapter = new
    // MessageListenerAdapter(receiver);
    // messageListenerAdapter
    // .setSerializer(new
    // Jackson2JsonRedisSerializer<>(GenerateParticipantAccountRequest.class));
    // return messageListenerAdapter;
    // }
    ...
    // MessageListenerAdapter(receiver);
    // messageListenerAdapter.setSerializer(new
    // Jackson2JsonRedisSerializer<>(UserRoleRequest.class));
    // return messageListenerAdapter;
    // }

    // @Bean("updateUserProfileMessageListener")
    // MessageListenerAdapter updateUserProfileListenerAdapter(AuthReceiver
    // receiver) {
    // ObjectMapper objectMapper = new ObjectMapper();
    // objectMapper.registerModule(new JavaTimeModule());
    ...
    // MessageListenerAdapter(receiver);
    // messageListenerAdapter.setSerializer(new
    // Jackson2JsonRedisSerializer<>(objectMapper, UserProfileRequest.class));
    // return messageListenerAdapter;
    // }
    ...
    // MessageListenerAdapter updateUserPasswordMessageListener(AuthReceiver
    // receiver) {
    // MessageListenerAdapter messageListenerAdapter = new
    // MessageListenerAdapter(receiver);
    // messageListenerAdapter.setSerializer(new
    ...
    // @Qualifier("registerMessageListener") MessageListenerAdapter
    // registerListenerAdapter,
    // @Qualifier("generateParticipantAccountMessageListener")
    // MessageListenerAdapter generateParticipantAccountMessageListener,
    // @Qualifier("updateUserStatusMessageListener") MessageListenerAdapter
    // updateUserStatusMessageListener,
    // @Qualifier("updateUserRoleMessageListener") MessageListenerAdapter
    // updateUserRoleMessageListener,
    // @Qualifier("updateUserProfileMessageListener") MessageListenerAdapter
    // updateUserProfileListenerAdapter,
    // @Qualifier("updateUserEmailMessageListener") MessageListenerAdapter
    // updateUserEmailMessageListener,
    // @Qualifier("updateUserPasswordMessageListener") MessageListenerAdapter
    // updateUserPasswordMessageListener) {
